...
namespace PracticaMVC.Controllers
{
    public class marcasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id_marcas,nombre_marcas,estados")] marcas marcas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_marcas,nombre_marcas,estados")] marcas marcas)
        {
